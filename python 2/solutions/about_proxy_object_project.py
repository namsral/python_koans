...
class Proxy(object):
    def __init__(self, target_object):
        ...
        # Couldn't get the koan to pass with the original
        #   initialization of the _obj attribute, my alternative:
    ...
    def __setattr__(self, name, value):
        object.__getattribute__(self, "_messages").append('{0}='.format(name))        
    ...
    def number_of_times_called(self, message):
        return len([i for i in self._messages if i == message])
